...
main(){
      ...
      int v1[10], v2[10];
      int i, pos, fim, valor, op, opcao;
      printf("informe os valores da lista 1 \n");
      fim = insere(v1); // insere os elementos na lista 1 e retorna o total (ultima posicao ocupada)
      printf("\ninforme os valores da lista 2 \n");
      fim = insere(v2); // insere os elementos na lista 2 e retorna o total (ultima posicao ocupada)
      ...
      while (op != 6){
            if (op == 1){
            	printf("informe a lista que deseja acessar: ");
            	scanf("%d", &opcao);
            	
				if(opcao == 1){
					printf("digite a POSICAO para acessa-la: ");
                	scanf("%d", &pos);
                	valor = acessa(v1, pos, fim);
                	printf("valor da posicao %d: %d\n", pos, valor);
        		}
                else if(opcao == 2){
				   	printf("digite a POSICAO para acessa-la: ");
                	scanf("%d", &pos);
                	valor = acessa(v2, pos, fim);
                	printf("valor da posicao %d: %d\n", pos, valor);
            	}
			}
